...
const TAGS = ['Java', 'Python', 'JavaScript', 'Flutter(dart)', 'HTML', 'CSS', 'Testing', 'Scripting(Bash)', 'Docker', 'API', 'Design patterns', 'Algorithmns & structures'];
...
React.createElement("h1", null, "My Skills Animation"), /*#__PURE__*/
React.createElement("p", null, "Welcome to my obtained skills")), /*#__PURE__*/
